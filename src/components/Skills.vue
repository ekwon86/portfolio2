...
export default {
  ...
  data() {
    return {
      frontEnd: [
        ...
        { lang: 'React', icon: 'react-original colored', percentage: '90' },
        { lang: 'Angular', icon: 'angularjs-plain colored', percentage: '90' },
        { lang: 'jQuery', icon: 'jquery-plain colored', percentage: '90' },
        {
          lang: 'Bootstrap',
          icon: 'bootstrap-plain colored',
          percentage: '100'
        },
        {
          lang: 'Typescript',
      ...
      backEnd: [
        ...
        { lang: 'MySQL', icon: 'mysql-plain colored', percentage: '70' }
      ],
      misc: [
        {
          lang: 'Version Management (Git)',
          icon: 'git-plain colored',
          percentage: '70'
        },
        { lang: 'Heroku', icon: 'heroku-original colored', percentage: '70' },
        ...
        {
          lang: 'Wordpress',
          icon: 'wordpress-plain colored',
          percentage: '80'
        },
        {
          lang: 'Photoshop',
          icon: 'photoshop-plain colored',
          percentage: '60'
        },
        {
          lang: 'Illustrator',
          icon: 'illustrator-plain colored',
          percentage: '60'
        }
      ],
      percentageArray: []
  ...
  methods: {
    animateFrontEndWidth() {
      let index = 0;
      const frontEndBars = document.getElementsByClassName(
        'frontend-level-bar'
      );
